...
**Vigilante** isimli açık kaynak kodlu uygulama, **Access Dots** özelliğini eski Android sürümlerinde kullanabilmenizi sağlıyordu. Bu işlev Android 12 ile işletim sistemine eklendiği için proje artık geliştirilmemektedir ve kaynak kodu arşivlenmiştir: [FunkyMuse/Vigilante](https://github.com/FunkyMuse/Vigilante)

### Vigilante (Arşivlendi)

![Vigilante](/assets/img/vigilante.webp)
